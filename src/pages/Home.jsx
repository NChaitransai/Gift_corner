    ...
    <div className="container animate-fade-in">
      ...
      <section className="hero-banner">
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', backgroundColor: 'rgba(0, 102, 204, 0.08)', padding: '0.5rem 1.25rem', borderRadius: '9999px', color: 'var(--color-primary)', fontSize: '0.9rem', marginBottom: '1.5rem', fontWeight: 600 }}>
            <Sparkles size={16} />
            <span> Personalized Gift Collection</span>
          </div>
          <h1 className="font-serif" style={{ fontSize: '3rem', lineHeight: '1.2', marginBottom: '1.5rem', fontWeight: 700, color: 'var(--color-text-main)' }}>
          ...
          <p style={{ color: 'var(--color-text-muted)', fontSize: '1.1rem', marginBottom: '2.5rem', lineHeight: '1.6' }}>
            Transform ordinary moments into extraordinary memories. Explore our handpicked collection of high-quality frames, accessories, mugs, kitchenware, and home decor perfect for any occasion.
          </p>
      ...
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', marginBottom: '4rem' }}>
        <div className="glass" style={{ padding: '2rem', textAlign: 'center' }}>
          <div style={{ display: 'inline-flex', padding: '1rem', borderRadius: '50%', backgroundColor: 'rgba(0, 102, 204, 0.08)', color: 'var(--color-primary)', marginBottom: '1.25rem' }}>
            <Sparkles size={24} />
          </div>
        ...
        <div className="glass" style={{ padding: '2rem', textAlign: 'center' }}>
          <div style={{ display: 'inline-flex', padding: '1rem', borderRadius: '50%', backgroundColor: 'rgba(85, 85, 85, 0.08)', color: 'var(--color-secondary)', marginBottom: '1.25rem' }}>
            <Truck size={24} />
          </div>
        ...
        <div className="glass" style={{ padding: '2rem', textAlign: 'center' }}>
          <div style={{ display: 'inline-flex', padding: '1rem', borderRadius: '50%', backgroundColor: 'rgba(40, 167, 69, 0.08)', color: 'var(--color-success)', marginBottom: '1.25rem' }}>
            <Clock size={24} />
          </div>
      ...
      {/* Brand CTA banner */}
      <section className="glass" style={{ padding: '3.5rem', textAlign: 'center', background: 'linear-gradient(135deg, var(--bg-card) 0%, var(--bg-card-hover) 100%)', border: '1px solid var(--border-glass-active)', borderRadius: '24px' }}>
